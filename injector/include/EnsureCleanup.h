...
public:
	...
	explicit CEnsureCleanup(TYPE t) : m_t(reinterpret_cast<UINT_PTR>(t)) { }
	...
	operator TYPE() const
	{ 
		return reinterpret_cast<TYPE>(m_t);
	}
...
{
public:
	EnsureReleaseRegionEx(PVOID pv = nullptr, HANDLE proc = nullptr) : m_pv(pv), m_proc(proc) { }
